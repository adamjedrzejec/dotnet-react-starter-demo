...
From zero to a production-ready `test-coverage` agent — with patterns for building your own

*February 2026 · VS Code 1.106+ · GitHub Copilot*

---

## Table of Contents

1. [Introduction — What Are Custom Agents?](#1-introduction--what-are-custom-agents)
2. [Prerequisites and Setup](#2-prerequisites-and-setup)
3. [Anatomy of an Agent File](#3-anatomy-of-an-agent-file)
4. [Key Concepts — Tools, Handoffs, and Subagents](#4-key-concepts--tools-handoffs-and-subagents)
5. [Walkthrough: Building the test-coverage Agent](#5-walkthrough-building-the-test-coverage-agent)
6. [Testing and Iterating on Your Agent](#6-testing-and-iterating-on-your-agent)
7. [Real-World Examples from the Community](#7-real-world-examples-from-the-community)
8. [Using the Agent Builder Agent](#8-using-the-agent-builder-agent)
9. [Sharing Agents Across Teams and Organizations](#9-sharing-agents-across-teams-and-organizations)
10. [Best Practices and Common Pitfalls](#10-best-practices-and-common-pitfalls)
11. [What's Next — Building More Agents](#11-whats-next--building-more-agents)
...
3. Choose **User profile** as the location
...
1. Create a `.github` repository in your organization (e.g., `your-org/.github`)
